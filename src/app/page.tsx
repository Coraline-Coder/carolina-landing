          ...
          <div className="gradient-border-card">
            <div className="gradient-border-card-inner p-8 md:p-12">
              ...
              <div className="relative text-center">
                ...
                <p className="text-sm text-[#6b7a8d] italic max-w-md mx-auto mb-8" style={{ fontFamily: "var(--font-inter)" }}>
                  No trabajo con marcas que quieran &quot;probar a ver que pasa&quot;. Si buscas magia, no soy la opcion. Si buscas sistema, hablemos.
                </p>

                <a
                  href="https://calendly.com/carolinabetancourt"
                  target="_blank"
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 mt-8 text-sm text-[#6b7a8d]">
                  <a href="https://wa.me/5223111396364" target="_blank" rel="noopener noreferrer" className="hover:text-[#e8edf3] transition-colors">
                    WhatsApp
                  </a>
                  <span>·</span>
                  <a href="mailto:carolinajuarezbetancourt@gmail.com" className="hover:text-[#e8edf3] transition-colors">
