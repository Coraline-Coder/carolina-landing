  ...
  return (<>
    ...
    <section style={{ background: "#4A7CF7", padding: isMob ? "60px 24px" : "100px 0" }}>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <a href="https://wa.me/522292924043" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", background: "#FFFFFF", color: "#4A7CF7", fontFamily: "var(--font-jost)", fontWeight: 500, fontSize: 13, letterSpacing: 1.5, textTransform: "uppercase" as const, padding: "14px 28px", borderRadius: 3, textDecoration: "none", transition: "all 0.3s" }}
    ...
    <section style={{ background: "#0A0F1E", padding: isMob ? "60px 24px" : "100px 0" }}>
      <div style={{ maxWidth: 960, margin: "0 auto", textAlign: "center" }}>
        ...
        <div style={{ marginTop: 48 }}>
          ...
          <a href="https://wa.me/522292924043" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", background: "#3B82F6", color: "#FFFFFF", fontFamily: "var(--font-jost)", fontWeight: 500, fontSize: 11, letterSpacing: 1.5, textTransform: "uppercase" as const, padding: "14px 28px", borderRadius: 3, textDecoration: "none", transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)" }}
