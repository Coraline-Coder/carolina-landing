...
style="padding-left:16px;" onwheel="this.blur()" onkeydown="if(event.key==='ArrowUp'||event.key==='ArrowDown')event.preventDefault()">
  ...
  <div class="card animate-in" id="results">
    ...
    <div class="cta-box">
      ...
      <p id="ctaDesc">Ese dinero no está perdido para siempre. Está mal dirigido. En 45 minutos te digo exactamente dónde está la fuga y cómo taparla.</p>
...
<script>
  ...
  function calcular() {
    ...
    if (roas < 1) {
      ...
      document.getElementById('ctaDesc').textContent = 'Ese dinero no está perdido para siempre. Está mal dirigido. En 45 minutos te digo exactamente dónde está la fuga y cómo taparla. Hablemos 15 minutos.';
    } else {
...
onwheel="this.blur()" onkeydown="if(event.key==='ArrowUp'||event.key==='ArrowDown')event.preventDefault()">
  ...
  <div class="card results animate-in" id="resultsCard">
    ...
    <div class="cta-section">
      ...
      <p id="ctaText">Ya identifiqué los puntos críticos de tu cuenta. En 45 minutos te explico exactamente qué cambiaría para mover esos números — con un plan de acción en tus manos en 24 horas.</p>
